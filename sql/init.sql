...
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI交互日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI任务表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ai_task_step`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI任务步骤表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `chapter_plot_memory`  (
  ...
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE,
  INDEX `idx_chapter_id`(`chapter_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '章节剧情记忆表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `novel_chapter`  (
  ...
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '章节表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `novel_chapter_plan`  (
  ...
  `planned_characters` json NULL COMMENT '登场角色规划',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE,
  INDEX `idx_volume_plan_id`(`volume_plan_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '小说章节规划表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `novel_character`  (
  ...
  `last_appearance_chapter` int NULL DEFAULT NULL COMMENT '最近一次出场的章节号',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '小说角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `novel_character_chapter`  (
  ...
  INDEX `idx_chapter_id`(`chapter_id` ASC) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色-章节关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for novel_character_power_system
-- ----------------------------
...
CREATE TABLE `novel_character_power_system`  (
  ...
  `current_realm_id` bigint NULL DEFAULT NULL COMMENT 'Current realm level (novel_power_system_level.id)',
  `current_sub_realm_id` bigint NULL DEFAULT NULL COMMENT 'Current sub-realm step (novel_power_system_level_step.id)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_character_system`(`character_id` ASC, `power_system_id` ASC) USING BTREE,
  INDEX `idx_power_system_id`(`power_system_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Character-PowerSystem association' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for novel_continent_region
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '大陆区域表（树形结构）' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for novel_faction
-- ----------------------------
...
CREATE TABLE `novel_faction`  (
  ...
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE,
  INDEX `idx_parent_id`(`parent_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 93 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '势力表（树形结构）' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for novel_faction_character
-- ----------------------------
...
CREATE TABLE `novel_faction_character`  (
  ...
  INDEX `idx_character_id`(`character_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '势力-人物关联表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for novel_faction_region
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 166 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '势力-地区关联表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for novel_faction_relation
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 122 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '势力-势力关系表（双向存储）' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `novel_outline`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '小说大纲表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for novel_power_system
-- ----------------------------
...
CREATE TABLE `novel_power_system`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '力量体系表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for novel_power_system_level
-- ----------------------------
...
CREATE TABLE `novel_power_system_level`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_power_system_id`(`power_system_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '体系等级表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for novel_power_system_level_step
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 97 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '等级境界表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `novel_storyboard`  (
  ...
  INDEX `idx_chapter_id`(`chapter_id` ASC) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '小说章节分镜表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '小说分卷规划表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `novel_worldview`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '世界观设定表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for novel_worldview_power_system
-- ----------------------------
...
CREATE TABLE `novel_worldview_power_system`  (
  ...
  INDEX `idx_power_system_id`(`power_system_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '世界观-力量体系关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `project_basic_settings`  (
  ...
  INDEX `idx_project_id`(`project_id` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '项目基础设置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '活动日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI提供商表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_project`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '项目表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 110 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI提示词模板表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ai_prompt_template
-- ----------------------------
INSERT INTO `ai_prompt_template` VALUES (1, 'llm_chapter_generate_standard', '章节生成标准模板', 'llm', 'chapter_generate', 1, '用于生成小说章节的标准提示词模板，包含字数控制、情节要求等', '小说,章节,生成', 1, 1, NULL, '2026-02-05 05:25:20', NULL, '2026-03-19 06:44:39');
INSERT INTO `ai_prompt_template` VALUES (2, 'llm_outline_generate_detailed', '大纲生成详细模板', 'llm', 'outline_generate', 2, '用于生成小说完整大纲的提示词模板，包含分卷规划等', '小说,大纲,生成', 1, 1, NULL, '2026-02-05 05:25:39', NULL, '2026-02-26 18:39:53');
INSERT INTO `ai_prompt_template` VALUES (3, 'llm_worldview_create', '世界观创建模板', 'llm', 'worldview_create', 3, '用于创建小说世界观的提示词模板', '小说,世界观,生成', 1, 1, NULL, '2026-02-05 05:25:39', NULL, '2026-02-26 18:39:53');
INSERT INTO `ai_prompt_template` VALUES (4, 'llm_project_name_generate', '项目名称和描述生成模板', 'llm', 'project_generate', 4, '用于根据用户想法生成项目名称和描述的提示词模板，主角姓名要符合当前主流的命名风格，尽可能简洁明了的描述出整个故事的大纲，以及剧情走向', '项目,名称,生成', 1, 1, NULL, '2026-02-05 05:48:28', NULL, '2026-03-17 15:18:16');
INSERT INTO `ai_prompt_template` VALUES (5, 'llm_outline_volume_generate', '分卷规划生成模板', 'llm', 'outline_volume_generate', 5, '用于生成小说分卷规划的提示词模板，支持全新生成、继续生成、重新生成', '小说,大纲,分卷,生成', 1, 1, NULL, '2026-02-06 14:21:13', NULL, '2026-03-28 15:07:18');
INSERT INTO `ai_prompt_template` VALUES (6, 'llm_outline_chapter_generate', '章节规划生成模板', 'llm', 'outline_chapter_generate', 6, '用于生成分卷章节规划的提示词模板，包含专业网文结构设计指导', '小说,大纲,章节,生成', 1, 1, NULL, '2026-02-06 14:21:54', NULL, '2026-04-10 19:50:25');
INSERT INTO `ai_prompt_template` VALUES (7, 'llm_outline_character_generate', '角色生成模板', 'llm', 'outline_character_generate', 7, '用于生成分卷角色的提示词模板', '小说,大纲,角色,生成', 1, 1, NULL, '2026-02-06 14:22:35', NULL, '2026-02-26 18:39:53');
INSERT INTO `ai_prompt_template` VALUES (8, 'llm_chapter_compress', '章节内容压缩模板', 'llm', 'chapter_generation', 8, '用于压缩超长的章节内容，保持剧情不变，减少冗余描述', '小说,章节,压缩', 1, 1, NULL, '2026-02-11 12:23:51', NULL, '2026-03-28 15:07:53');
INSERT INTO `ai_prompt_template` VALUES (9, 'llm_protagonist_create', '主角生成模板', 'llm', 'protagonist_create', 9, '用于生成小说主角的提示词模板，包含姓名、性别、年龄、性格、外貌、背景等', '小说,主角,生成,人物', 1, 1, NULL, '2026-02-12 14:02:56', NULL, '2026-03-28 15:07:54');
INSERT INTO `ai_prompt_template` VALUES (10, 'llm_character_extract', '章节人物提取模板', 'llm', 'character_extract', 10, '用于从章节内容中提取人物信息的提示词模板', '小说,人物,提取', 1, 1, NULL, '2026-02-12 14:34:00', NULL, '2026-03-28 15:07:30');
INSERT INTO `ai_prompt_template` VALUES (11, 'llm_chapter_fix_check', '章节问题检查模板', 'llm', 'chapter_fix_check', 11, 'AI剧情修复-问题检查阶段，检测章节中的逻辑问题、设定矛盾、连贯性问题等', NULL, 1, 1, 1, '2026-03-03 12:52:22', NULL, '2026-03-28 15:07:44');
INSERT INTO `ai_prompt_template` VALUES (12, 'llm_chapter_fix_apply', '章节修复应用模板', 'llm', 'chapter_fix_apply', 12, 'AI剧情修复-应用修复阶段，根据问题清单修复章节内容', NULL, 1, 1, 1, '2026-03-03 12:55:24', NULL, '2026-03-28 15:07:44');
INSERT INTO `ai_prompt_template` VALUES (13, 'llm_volume_optimize', '分卷优化模板', 'llm', 'volume_optimize', 13, '用于AI优化单个分卷详情的提示词模板，参考世界观和前面所有卷的信息', NULL, 1, 1, NULL, '2026-03-16 09:06:21', NULL, '2026-03-28 15:07:44');
INSERT INTO `ai_prompt_template` VALUES (14, 'llm_chapter_memory_extract', '章节剧情记忆提取模板', 'llm', 'chapter_memory_extract', 14, '从章节内容提取核心信息，用于后续剧情连贯承接', '小说,章节,记忆,提取', 1, 1, NULL, '2026-03-17 13:00:33', NULL, '2026-03-28 15:07:44');
INSERT INTO `ai_prompt_template` VALUES (15, 'llm_chapter_character_extract', '章节角色提取模板', 'llm', 'character_extract', 15, '从章节内容中提取角色信息的提示词模板', '小说,角色,提取', 1, 1, NULL, '2026-03-18 14:02:55', NULL, '2026-04-10 19:50:28');
INSERT INTO `ai_prompt_template` VALUES (16, 'llm_geography_create', '地理环境独立生成', 'llm', 'worldview_geography_generate', 16, '独立生成地理环境设定，输出<g>标签格式XML', '地理环境,世界观,独立生成', 1, 1, NULL, '2026-04-03 14:34:42', NULL, '2026-04-03 15:29:18');
INSERT INTO `ai_prompt_template` VALUES (17, 'llm_power_system_create', '力量体系独立生成', 'llm', 'worldview_power_system_generate', 17, '独立生成力量体系设定，输出<p>标签格式XML', '力量体系,世界观,独立生成', 1, 1, NULL, '2026-04-03 15:28:18', NULL, '2026-04-03 15:29:18');
INSERT INTO `ai_prompt_template` VALUES (18, 'llm_faction_create', '阵营势力独立生成', 'llm', 'worldview_faction_generate', 18, '独立生成阵营势力设定，输出<f>标签格式XML，需要已生成的地理环境和力量体系数据作为上下文', '阵营势力,世界观,独立生成', 1, 1, NULL, '2026-04-03 15:28:29', NULL, '2026-04-03 15:29:18');
...
CREATE TABLE `ai_prompt_template_version`  (
                                               ...
                                               INDEX `idx_is_active`(`is_active` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI提示词模板版本表' ROW_FORMAT = Dynamic;

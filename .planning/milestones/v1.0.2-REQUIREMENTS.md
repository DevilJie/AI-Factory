# Requirements Archive: v1.0.2 势力阵营结构化重构
...
- [x] **BACK-07**: FactionController REST API（CRUD 端点）
- [x] **BACK-08**: 势力-地区关联 CRUD API
- [x] **BACK-09**: 势力-人物关联 CRUD API（含 role 字段）
- [x] **BACK-10**: 势力-势力关系 CRUD API
...
- [x] **UI-02**: faction.ts API 客户端（CRUD 接口）
